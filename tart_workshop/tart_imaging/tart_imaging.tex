...
\begin{frame}{Multiplying Fringes}
...
\begin{columns}
 \begin{column}{0.5\linewidth}
    ...
    \end{minipage}
 \end{column}
\begin{column}{0.5\linewidth} $e^{2 \pi}$ = \raisebox{-0.4\height}{ \includegraphics[height=4cm]{images/harmonics-phase/fringe_0_6.283185307179586.png}}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{The probability of the sky}
 ...
 \begin{itemize}
  ...
  \item How close depends on the noise. Define a likelihood: \[ P(\theta, \phi) = e^{-\left(\frac{F_{ij(\theta, \phi)} - \psi}{\sigma_\psi}\right)^2}  \]
 \end{itemize}
