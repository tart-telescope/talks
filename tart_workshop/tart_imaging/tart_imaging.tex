...
\title[TART Imaging]{Imaging with the TART: Getting the tools}
...
%    \includegraphics[width=\linewidth]{fig/albatross_frame.png}
  The TART software for imaging run in an environment called stimela. This is the software framework for the worlds largest radio telescopes.
  ...
  Notes:
  \begin{itemize}
   \item This should work on linus and windows (WSL2).
   \item Probably not on apples. Run a linux virtual machine.
  \end{itemize}
...
\begin{lstlisting}[language=Python, frame=single, basicstyle=\footnotesize]
 ...
 api_endpoint = "https://api.elec.ac.nz/tart/tart-kenya/api/"
