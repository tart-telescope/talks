...
\logo{
  ...
  \pgfputat{\pgfxy(-1,6.9)}{\pgfbox[center,base]{\includegraphics[width=1.5cm]{../tart_overview/fig/UofOtago_logo.pdf}}}
}

\date[Feb 2026] % (optional, should be abbreviation of conference name)
{}
