...
\begin{frame}{Introduction}
	\begin{itemize}
		...
		\item 10+ telescopes deployed across the globe on various continents (Africa, Asia, Oceania, and soon Europe \& North America)
...
\begin{frame}{Why an API Spec Matters --- in the Age of AI}
	...
	\vspace{0.3cm}
	\begin{itemize}
		\item \textbf{AI agents can (please not) operate the telescope}
		      \begin{itemize}
			      \item LLMs read OpenAPI specs natively
			      \item Can help build control and autonomous calibration systems
			      \item Develop monitoring and acquisition scheduling
		      \end{itemize}
